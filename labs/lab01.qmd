...
## 5. «Ποια αναπαράσταση πάει με ποια μεταβλητή;»  
*(πίνακας-κανόνας)*
...
| Ordinal (categorical) | n (%) (με σωστή σειρά) | Bar plot (με σειρά) |
...
Δημιούργησε μια μεταβλητή risk_group με 3 επίπεδα: Low/Medium/High, ordered, με βάσει τη συστολική πίεση:
	•	Low: < 120
	•	Medium: 120–139
	•	High: ≥ 140
